<html>
<head>
<title>e-clinic | change-booking</title>
...
<body style="background-image:url(mgrchange.jpg)">
	<div class="header">
		<ul>
		<li class="dropdown"><font color="skyblue" size="10"> <img src="logo.png" width="10%" height=""> <strong>-clinic</strong> MANAGER MODE</font></li>
<br>
