...
<html>
<head>
<title>e-clinic | show-clinic</title>
...
<body background= "adminbackground.jfif">

<ul>
<li class="dropdown"><font color="skyblue" size="10"> <img src="logo.png" width="10%" height=""> <strong>-clinic</strong> Admin MODE</font></li>
<br>
<h2>
  <li class="dropdown">    
...
$con = mysqli_connect('localhost','marsha','1245','hospital');
if (!$con)
{
