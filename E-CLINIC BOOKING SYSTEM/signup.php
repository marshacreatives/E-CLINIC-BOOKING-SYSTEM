<html>
<head>
<title>e-clinic | Sign up</title>
	<link rel="stylesheet" href="main.css">
</head>
<body style="background-image:url(images/locateus.jpg)">
<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/logo.png" width="30px" height="30px"><strong>-clinic</strong>Appointment Booking System</a></li>
