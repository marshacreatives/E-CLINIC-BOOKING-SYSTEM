<html>
<head>
<title>e-clinic | locate-us</title>
...
<body style="background-image:url(images/locateus.jpg)">
	<div class="header">

		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo"><img src="images/logo.png" width="30px" height="30px"><strong> -clinic </strong>Appointment Booking System</a></li>
	...
	<div class="sucontainer" style="background-image:url(images/locateus.jpg)">
		<ul style="background-image:url(images/locateus.jpg)">	
