...
<div class="container" style="width:100%">
	...
	<h1>e-clinic</h1><br>
      ...
      <button type="button" onclick="window.location.href='book.php'" style="background-color:#2B4F76; left:45%">Book Appointment</button>
	  <br> <br> <br> <br>
	  <button type="button" onclick="window.location.href='viewpatientappointments.php'" style="background-color:#2B4F76;left:45%">Show Appointments</button>
	  <br> <br> <br> <br>
	  <button type="submit" name="cancel" style="float:center;background-color:#2B4F76;left:45%">Cancel Booking</button>
