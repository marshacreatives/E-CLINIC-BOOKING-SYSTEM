...
<link rel="stylesheet" href="main.css">
			<div class="header">
				<ul>
					<li style="float:left;border-right:none"><a href="cover.php" class="logo"><img src="images/logo.png" width="30px" height="30px"><strong> - clinic </strong> Booking System</a></li>
			...
			<div class="center">
				<h1>e-clinic</h1><br>
				<p style="text-align:center;color:white;font-size:30px;top:35%">e-clinic Appointment Booking System</p><br>
